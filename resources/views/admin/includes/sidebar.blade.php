  ...
  <aside class="app-sidebar" id="sidebar">
      ...
      <div class="main-sidebar-header">
          <a href="{{ route('home') }}" class="header-logo">
              <img src="" alt="logo" class="main-logo mx-auto" />
          </a>
      </div>
              ...
              <ul class="main-menu">
                  ...
                  {{-- <li
                      ...
                      <a href="javascript:void(0);"
                          class="side-menu__item {{ request()->routeIs('dashboard') || request()->routeIs('products') ? 'active' : '' }}">
                      ...
                      <ul class="slide-menu child1">
                          <li class="slide">
                              <a href="{{ route('home') }}"
                                  class="side-menu__item {{ request()->routeIs('dashboard') ? 'active' : '' }}">Category</a>
                          </li>
                          <li class="slide">
                              <a href="{{ route('home') }}"
